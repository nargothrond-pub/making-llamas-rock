...
# --- Hardware / Devices ---
# Default to AMD ROCm devices. Nvidia users can override this (e.g. DEVICES="--gpus all")
...
# Default arguments passed to the llama.cpp server
...
.PHONY: run download stop logs status help
...
run: stop
	...
	@echo "🚀 Starting $(CONTAINER_NAME) using $(ENGINE) with model $(MODEL_FILE)..."
...
status:
	...
	@$(ENGINE) ps -f name=$(CONTAINER_NAME)
...
help:
	...
	@echo "  make logs                   View real-time server logs"
	...
	@echo "  ENGINE=podman               Container runtime (podman or docker)"
	@echo "  DEVICES=\"...\"               Hardware device mappings"
